    ...
    return (
        <div className="container mx-auto my-20 flex items-center justify-center bg-base-200 p-3 min-h-[80vh] px-4">
            ...
            <div className="bg-white w-md p-10 rounded shadow-md hover:shadow-xl transition-shadow duration-75">
                ...
                <p className="text-gray-400 text-xs font-semibold my-2 text-center">Dont have an Account? Please <Link href={'/register'}><span className="text-blue-600 text-xs font-md underline">Register</span></Link></p>
                ...
                <div className="">
                    <button type="button" onClick={handleGoogleSignin} className="btn shadow-md bg-white text-black border-[#e5e5e5] w-full">
